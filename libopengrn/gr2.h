...
*/
OG_DLLAPI extern bool Gr2_Load(const uint8_t* src, size_t len, TGr2* gr2);

OG_DLLAPI extern bool Gr2_Compose(TGr2* gr2);
...
*/
OG_DLLAPI extern void Gr2_SetDefaultInfo(TGr2* gr2, bool is64, bool isBe, uint32_t fileFormat);
...
*/
OG_DLLAPI extern TElementGeneric* Gr2_AddElement(TGr2* gr2, uint8_t type, const char* name, TElementGeneric* root);
