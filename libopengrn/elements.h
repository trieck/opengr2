...
typedef struct SElementGeneric
{
    ...
    uint32_t size;
    /// Size of the element array (which is also used in the number of array elements), in case of string this will determine the length
} TElementGeneric;
...
extern bool Element_Parse(TDArray* vptr, const uint8_t* type, const uint8_t* data, bool is64, TDArray* global,
