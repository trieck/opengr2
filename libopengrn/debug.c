...
void dbg_printelement(TElementGeneric* elem)
{
    ...
    for (int32_t i = 0; i < elem->size; i++) {
        ...
        case TYPEID_TRANSFORM: // 9
        {
            ...
            printf(
                "flags %u x %f y %f z %f rotationx %f rotationy %f rotationz %f rotationw %f scaleshear %f %f %f %f %f %f %f %f %f",
                tr.flags, tr.translation[0], tr.translation[1], tr.translation[2], tr.rotation[0], tr.rotation[1],
                tr.rotation[2], tr.translation[3],
                tr.scaleShear[0][0], tr.scaleShear[0][1], tr.scaleShear[0][2], tr.scaleShear[1][0], tr.scaleShear[1][1],
                tr.scaleShear[1][2], tr.scaleShear[2][0], tr.scaleShear[2][1], tr.scaleShear[2][2]);
            break;
        }
        }
    }
